...
if __name__ == '__main__':
    ...
    data_generator = KatwijkRocks(32, img_size, input_img_paths, 
            target_img_paths, color_threshold = 1)

    model_path = ""
    temp_dir = mlflow.artifacts.download_artifacts(model_path)
    print(temp_dir)
    ...
    preds_compressed = compressed_predict(interpreter, input_img_paths)
    preds = []
    ...
    eval_preds(preds_compressed, target_img_paths, 'katwijk compressed')